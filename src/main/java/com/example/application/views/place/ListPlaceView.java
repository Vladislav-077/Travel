...
@PageTitle("Список Мест")
@Route(value = "listPlace")
public class ListPlaceView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public ListPlaceView() {
        addClassName("list-place-view");
        setSizeFull();
